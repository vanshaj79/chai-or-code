...
const loginUser = asyncHandler(async (req,res) => {
    ...
    const options = {
        ...
        secure: true    // ensuring cookies are sent only over HTTPS
    };
...
const refreshAccessToken = asyncHandler(async (req,res) => {
    ...
    try {
        ...
        // checking incomingrefreshtoken is valid or not 
        ...
        return res.status(200).cookie("accessToken", accessToken).cookie("refreshToken", newRefreshToken).json(new ApiResponse(200, { accessToken, newRefreshToken },"AccessToken refreshed"))
    } catch (error) {
...
const getCurrentUser = asyncHandler(async (req,res) => {
    return res.status(200).json(new ApiResponse(200, req.user, "Current fetched Successfully"))
})
...
const updateAccountDetails = asyncHandler(async(req, res) => {
    ...
    const user = await User.findByIdAndUpdate(
        ...
        { new: true }// if new is true then after updation completing it returns the information(updated)
    ).select("-password")
